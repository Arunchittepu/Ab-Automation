describe('template spec', () => {
  ...
  it('click on Amazon Music Module and check the sub modules inside', () =>{
    ...
    cy.contains('Download the app',{ timeout: 10000 }).scrollIntoView().should('have.length','1')
    ...
    it('Kindle E-readers & Books',() => {
      ...
      cy.wait(3000);
      cy.contains('div.hmenu-item.hmenu-title', 'Kindle E-readers').should('be.visible').click({ force: true });
      cy.wait(3000);
